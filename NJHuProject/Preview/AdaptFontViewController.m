...
@interface AdaptFontViewController ()<UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray<Paragraph *> *paragraphs;

@end

@implementation AdaptFontViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    AdaptFontCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AdaptFontCell" forIndexPath:indexPath];
    cell.paragraph = [self.paragraphs objectAtIndex:indexPath.row];
    return cell;
}
...
- (UITableView *)tableView {
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[AdaptFontCell class] forCellReuseIdentifier:@"AdaptFontCell"];
...
- (NSMutableArray<Paragraph *> *)paragraphs {
    if (_paragraphs == nil) {
        ...
        [datas enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            paragraph.words = obj;
            paragraph.date = [[NSDate date] stringWithFormat:@"yyyy-MM-dd ss"];
